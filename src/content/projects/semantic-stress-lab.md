...
summary: "Adversarial benchmark testing how literary syntax (hyperbaton, neologism, metaphor) degrades embedding fidelity and induces LLM hallucination in Portuguese texts."
stack: ["BGE-M3", "LaBSE", "EmbeddingGemma", "Python"]
status: "in progress"
metrics: ["25 annotated pairs", "3 embedding models compared", "Mean cosine similarity: 0.76 (BGE-M3)"]
...
bidirectional entailment check, in [`docs/METHODOLOGY.md`](https://github.com/lalabohm/semantic-stress-lab/blob/main/docs/METHODOLOGY.md).
Annotation criteria in [`docs/ANNOTATION_GUIDE.md`](https://github.com/lalabohm/semantic-stress-lab/blob/main/docs/ANNOTATION_GUIDE.md).
...
([`_v1` suffixed files](https://github.com/lalabohm/semantic-stress-lab/blob/main/results/phase1_embeddings/cosine_similarity_by_model_v1.csv)),
...
[`archive/`](https://github.com/lalabohm/semantic-stress-lab/tree/main/archive/) and the "Future work" section in
[`docs/METHODOLOGY.md`](https://github.com/lalabohm/semantic-stress-lab/blob/main/docs/METHODOLOGY.md) for what it was and why it
was discontinued.
